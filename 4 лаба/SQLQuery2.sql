...
from AUDITORIUM inner join AUDITORIUM_TYPE
on AUDITORIUM.AUDITORIUM_TYPE = AUDITORIUM_TYPE.AUDITORIUM_TYPE
and AUDITORIUM_TYPENAME like '%комп%';
...
---4 задание
select FACULTY.FACULTY as 'Факультет', PULPIT.PULPIT as 'Кафедра', PROFESSION.PROFESSION_NAME as 'Специальность', SUBJECT_T.SUBJECT_NAME as 'Название дисциплины', STUDENT.NAME as 'ФИО студента',
case
